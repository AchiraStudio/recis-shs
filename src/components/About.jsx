        ...
        <div className="bento-grid" ref={containerRef}>
          <div className="bento-item main-card glass-panel reveal-item delay-3">
            ...
            <div className="content-inner">
              <div className="card-top"><span className="card-label">Est. 1948</span><div className="icon-badge"><FiActivity /></div></div>
              ...
              <div className="stat-row">
                ...
                <div className="stat"><b>75+</b> <span>Years</span></div>
              </div>
            </div>
          </div>
          ...
          <div className="bento-item vision-card glass-panel reveal-item delay-4">
             ...
             <div className="content-inner">
               ...
               <h3>Our Vision</h3>
               <p className="vision-quote">"To become a premier academic institution grounded in the spirit of FMM."</p>
               <div className="tags-container"><span className="tag">Excellence</span><span className="tag">Integrity</span></div>
             </div>
          </div>
          ...
          <div className="bento-item mission-card glass-panel reveal-item delay-5">
            <div className="spotlight-overlay"></div>
            <div className="content-inner">
              <div className="mission-header"><h3>Mission Protocols</h3><div className="divider-line"></div></div>
              <ul className="mission-list">
                <li><div className="li-icon"><FiAward /></div><span>Academic Excellence</span></li>
                <li><div className="li-icon"><FiGlobe /></div><span>Global Perspective</span></li>
                <li><div className="li-icon"><FiCpu /></div><span>Tech Integration</span></li>
              </ul>
            </div>
          </div>
        </div>
